...
* EndeavourOSWSL2 supports systemd natively if you are running wsl v0.67.6 and above. More details are available [here](https://devblogs.microsoft.com/commandline/systemd-support-is-now-available-in-wsl/).
